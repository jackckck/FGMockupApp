...
public class MainActivity extends AppCompatActivity
    ...
    public TabLayout.Tab tab0, tab1;
    ...
    private void setTabNames(String s) {
        ...
        if (s.equals("Friends")) {
            ...
            if (fgTabs.getTabCount() == 2) {
                TabLayout.Tab tab = fgTabs.newTab();
                fgTabs.addTab(tab);
                tab.setText("Blocked");
            } else {
                fgTabs.getTabAt(2).setText("Blocked");
            }
        } else if (s.equals("User")) {
            tab0.setText("Profile");
            tab1.setText("My servers");
            if (fgTabs.getTabCount() == 3) {
                fgTabs.removeTabAt(2);
            }
        }
    }

    public void handleErrorCode(Integer errorCode, TextView errorText) {
        switch (errorCode) {
            case 400:
                errorText.setText("Bad request");
                break;
            case 401:
                errorText.setText("Unauthorised user");
                break;
            case 404:
                errorText.setText("Requested data not found");
                break;
        }
